...
const (
	sessionTimeoutMin     = 100 * time.Millisecond            // 100ms
	sessionTimeoutMax     = 30 * 60 * 1000 * time.Millisecond // 30 minutes
	sessionTimeoutDefault = 60 * 1000 * time.Millisecond      // 60s
