...
public class PropertyTab2Adv : PropertyTab
{
	public override string TabName => "Advance";

	public override Bitmap Bitmap => new Bitmap(Resources.propertyAdvance);
	...
	public override PropertyDescriptorCollection GetProperties(object component, Attribute[] attributes)
	{
		...
		{
			if (propertyDescriptorCollection[i].Attributes[typeof(EditorBrowsableAttribute)] != null && ((EditorBrowsableAttribute)propertyDescriptorCollection[i].Attributes[typeof(EditorBrowsableAttribute)]).State == EditorBrowsableState.Advanced)
			{
