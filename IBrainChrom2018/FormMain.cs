...
public class FormMain : Form, FrmChromatManagerInterface, ChromFormInterface
{
	...
	private string serviceFilePath = Application.StartupPath + "\\watchDateTime.exe";
	...
	public static FormMain fromMain = null;

	public ChromFormCtrl chromFormCtrl2;

	private TabControl tabCtrl2;

	private SplitContainer splitContainerQT;
	...
	private ToolStripMenuItem 登录账号ToolStripMenuItem;

	private ToolStripMenuItem 重新登录账号ToolStripMenuItem;

	private System.Windows.Forms.Timer timerLow;
	...
	public FormMain()
	{
		...
		lbTHC.Visible = false;
		登录账号ToolStripMenuItem.Visible = false;
	...
	private void FormMain_Load(object sender, EventArgs e)
	{
		...
		try
		{
			string path2 = Application.StartupPath + "\\modbusdata.txt";
			...
			if (text == "Restart")
			{
				for (int i = 0; i < 2000; i++)
				{
					...
					cdlMgr.tcpServerMgr.mComModbus.WordVaue[i] = ushort.Parse(text);
				}
				int j = 0;
				int num = 0;
				for (; j < 2000; j++)
	...
	private void FormMain_FormClosing(object sender, FormClosingEventArgs e)
	{
		...
		if (selfRestart)
		{
			...
			{
				m_bIsClosing = true;
				string path = Application.StartupPath + "\\modbusdata.txt";
				StreamWriter streamWriter = new StreamWriter(path, append: false, Encoding.UTF8);
				streamWriter.WriteLine("Restart");
				for (int i = 0; i < 2000; i++)
				{
					streamWriter.WriteLine(cdlMgr.tcpServerMgr.mComModbus.WordVaue[i].ToString());
				}
				streamWriter.Close();
			...
			LogMgr.Instance.LogError("软件自动重启");
		}
		if (!m_bIsClosing)
		{
	...
	private void timer_1_Tick(object sender, EventArgs e)
	{
		try
		{
			...
			if (!((float)Process.GetCurrentProcess().PrivateMemorySize64 / 1048576f > 1000f))
			{
				return;
			}
	...
	private void method_5(byte[] byte_0, TcpServerEventArgs tcpServerEventArgs_0, int int_3)
	{
		...
		case 1:
		{
			...
			{
			case 10000:
				if (oneInstrumByMID.BControlTemp)
				{
					b2 = 1;
				}
				break;
			...
			case 10004:
				...
				break;
			case 10006:
				if (oneInstrumByMID.Bfire1)
				{
					b2 = 1;
				}
				break;
			case 10007:
				if (oneInstrumByMID.Bfire2)
				{
					b2 = 1;
				}
				break;
			case 10008:
				if ((oneInstrumByMID.eventState & 1) == 1)
				{
					b2 = 1;
				}
				break;
		...
		case 3:
		{
			...
			bool flag = false;
			bool flag2 = true;
			chromatogram_0 = oneInstrumByMID.bgChromModbus;
			...
			cdlMgr.tcpServerMgr.modBusData_0.ModBusBytes[57] = (byte)StateYiqi;
		...
		case 5:
			if (oneInstrumByMID != null)
			{
				...
				case 10005:
					if (array[10] == byte.MaxValue)
					{
						oneInstrumByMID.SendCmd(22, 3);
					}
					else
					{
						oneInstrumByMID.SendCmd(23, 3);
					}
					break;
				case 10006:
					if (array[10] == byte.MaxValue)
					{
						oneInstrumByMID.SendCmd(20);
					}
					break;
				case 10007:
					if (array[10] == byte.MaxValue)
	...
	public void Check_reg_sdaFileType()
	{
		...
		fileTypeRegInfo.Description = Lang.PS("IBrainChrom谱图文件");
		fileTypeRegInfo.ExePath = Application.StartupPath + "\\IBrainChrom.exe";
		fileTypeRegInfo.ExtendName = ".sda";
		fileTypeRegInfo.IcoPath = Application.StartupPath + "\\2.ico";
	...
	public void SetCurrentChromDevice()
	{
		...
		else
		{
			...
			ReloadMisMgr();
			ChromDeviceCtrl.selfCtrl.chbSeq.Checked = cdlMgr.CurrentTcpServerSocket.cH4Param.bSeq;
			ChromDeviceCtrl.selfCtrl.tbSeq1.Text = cdlMgr.CurrentTcpServerSocket.cntSeq1.ToString();
			ChromDeviceCtrl.selfCtrl.tbSeq2.Text = cdlMgr.CurrentTcpServerSocket.cntSeq2.ToString();
			ChromDeviceCtrl.selfCtrl.tbSeq3.Text = cdlMgr.CurrentTcpServerSocket.cntSeq3.ToString();
			ChromDeviceCtrl.selfCtrl.tbSeq4.Text = cdlMgr.CurrentTcpServerSocket.cntSeq4.ToString();
			m_bLoading = false;
	...
	private void MainmstSet_OnMethodSaveEvent(object sender, EventArgs e)
	{
		...
		else if (cdlMgr.GetChartParaOpera(1) != null)
		{
			...
			if (MicrFPDCtrl.selfCtrl != null)
			{
				...
				if (cdlMgr.GetChartParaOpera(1).mtdMgr.caliGnl != null)
				{
					for (int num2 = 0; num2 < MicrFPDCtrl.selfCtrl.strCompName.Length && num2 < cdlMgr.GetChartParaOpera(1).mtdMgr.caliGnl.cmpds.Length; num2++)
					{
						MicrFPDCtrl.selfCtrl.strCompName[num2] = cdlMgr.GetChartParaOpera(1).mtdMgr.caliGnl.cmpds[num2].cmpdInfo.name;
					}
				}
			}
		}
		...
		{
			for (int num5 = 0; num5 < cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl.cmpds.Length; num5++)
			{
				switch (num5)
				{
				case 0:
					tabRltCtrl.selfCtrl.label4.Text = cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl.cmpds[num5].cmpdInfo.name;
					break;
				case 1:
					tabRltCtrl.selfCtrl.label7.Text = cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl.cmpds[num5].cmpdInfo.name;
					break;
				case 2:
					tabRltCtrl.selfCtrl.label6.Text = cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl.cmpds[num5].cmpdInfo.name;
					break;
				case 3:
					tabRltCtrl.selfCtrl.label5.Text = cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl.cmpds[num5].cmpdInfo.name;
					break;
				case 4:
					tabRltCtrl.selfCtrl.label9.Text = cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl.cmpds[num5].cmpdInfo.name;
					break;
				}
			}
		}
		...
		for (int num6 = 0; num6 < FormOnline.selfCtrl.lstSource1.Count; num6++)
		{
			FormOnline.selfCtrl.lstSource1[num6].name = "";
			FormOnline.selfCtrl.lstSource2[num6].name = "";
			FormOnline.selfCtrl.lstSource3[num6].name = "";
			FormOnline.selfCtrl.lstSource4[num6].name = "";
		}
		for (int num7 = 0; num7 < FormOnline.selfCtrl.lstBSource1.Count; num7++)
		{
			FormOnline.selfCtrl.lstBSource1[num7].name = "";
			FormOnline.selfCtrl.lstBSource2[num7].name = "";
			FormOnline.selfCtrl.lstBSource3[num7].name = "";
			FormOnline.selfCtrl.lstBSource4[num7].name = "";
		}
		if (cdlMgr.ChartParaOperaList[0].mtdMgr.caliGnl != null)
		{
			for (int num8 = 0; num8 < FormOnline.selfCtrl.strCompName.Length && num8 < cdlMgr.ChartParaOperaList[0].mtdMgr.caliGnl.cmpds.Length; num8++)
			{
				FormOnline.selfCtrl.lstSource1[num8].name = cdlMgr.ChartParaOperaList[0].mtdMgr.caliGnl.cmpds[num8].cmpdInfo.name;
				FormOnline.selfCtrl.lstSource2[num8].name = FormOnline.selfCtrl.lstSource1[num8].name;
				FormOnline.selfCtrl.lstSource3[num8].name = FormOnline.selfCtrl.lstSource1[num8].name;
				FormOnline.selfCtrl.lstSource4[num8].name = FormOnline.selfCtrl.lstSource1[num8].name;
			}
		}
		if (cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl != null)
		{
			for (int num9 = 0; num9 < cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl.cmpds.Length; num9++)
			{
				FormOnline.selfCtrl.lstBSource1[num9].name = cdlMgr.ChartParaOperaList[1].mtdMgr.caliGnl.cmpds[num9].cmpdInfo.name;
				FormOnline.selfCtrl.lstBSource2[num9].name = FormOnline.selfCtrl.lstBSource1[num9].name;
				FormOnline.selfCtrl.lstBSource3[num9].name = FormOnline.selfCtrl.lstBSource1[num9].name;
				FormOnline.selfCtrl.lstBSource4[num9].name = FormOnline.selfCtrl.lstBSource1[num9].name;
			}
		}
	...
	private void UpdateSysteamState()
	{
		if (Class49.bUpdateDataCtrl)
		{
			Class49.bUpdateDataCtrl = false;
			if (cdlMgr.CurrentTcpServerSocket != null)
			{
				ChromDeviceCtrl.selfCtrl.tbSeqCur1.Text = cdlMgr.CurrentTcpServerSocket.cntSeq1.ToString();
				ChromDeviceCtrl.selfCtrl.tbSeqCur2.Text = cdlMgr.CurrentTcpServerSocket.cntSeq2.ToString();
				ChromDeviceCtrl.selfCtrl.tbSeqCur3.Text = cdlMgr.CurrentTcpServerSocket.cntSeq3.ToString();
				ChromDeviceCtrl.selfCtrl.tbSeqCur4.Text = cdlMgr.CurrentTcpServerSocket.cntSeq4.ToString();
			}
		}
	}
	...
	private void 权限管理ToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		{
			frmRightsManager frmRightsManager2 = new frmRightsManager();
			frmRightsManager2.Show();
			return;
		}
		MessageBox.Show(Lang.PS("请以管理员身份登录软件！", "Please log in as administrator！"), Lang.PS("提示", "Tips"), MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
	}
	...
	private void 重新登录账号ToolStripMenuItem_Click(object sender, EventArgs e)
	{
		Logon logon = new Logon();
		logon.TopMost = true;
		if (logon.ShowDialog() != DialogResult.OK)
	...
	private void timerLow_Tick(object sender, EventArgs e)
	{
		...
		if (paramBase.IsDirty)
		{
			paramBase.SaveFinally();
		}
		GC.Collect();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IBrainChrom2018.FormMain));
		...
		this.重新登录账号ToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
		...
		this.timerLow = new System.Windows.Forms.Timer(this.components);
		...
		this.spcLeftBottom.Panel1.SuspendLayout();
		this.spcLeftBottom.Panel2.SuspendLayout();
		...
		this.splitContainer1.Panel2.Controls.Add(this.insDeviceCtrl1);
		...
		this.splitContainer2.Panel1.Controls.Add(this.chromAcqCtrl1);
		this.splitContainer2.Panel1.Controls.Add(this.tabChannel);
		this.splitContainer2.Panel2.Controls.Add(this.spcLeftBottom);
		this.splitContainer2.Size = new System.Drawing.Size(867, 714);
		...
		this.tabChannel.Dock = System.Windows.Forms.DockStyle.Top;
		this.tabChannel.Location = new System.Drawing.Point(0, 0);
		this.tabChannel.Name = "tabChannel";
		this.tabChannel.SelectedIndex = 0;
		this.tabChannel.Size = new System.Drawing.Size(865, 22);
		...
		this.tabPage11.Size = new System.Drawing.Size(857, 0);
		...
		this.tabPage12.Size = new System.Drawing.Size(857, 0);
		...
		this.tabPage13.Size = new System.Drawing.Size(857, 0);
		...
		this.tabPage14.Size = new System.Drawing.Size(857, 0);
		...
		this.spcLeftBottom.Panel1.Controls.Add(this.chromDeviceCtrl1);
		this.spcLeftBottom.Panel1MinSize = 0;
		this.spcLeftBottom.Panel2.Controls.Add(this.label28);
		this.spcLeftBottom.Panel2.Controls.Add(this.lbTHC);
		this.spcLeftBottom.Panel2MinSize = 0;
		this.spcLeftBottom.Size = new System.Drawing.Size(865, 156);
		this.spcLeftBottom.SplitterDistance = 300;
		this.spcLeftBottom.SplitterWidth = 1;
		this.spcLeftBottom.TabIndex = 1;
		this.label28.AutoSize = true;
		this.label28.Font = new System.Drawing.Font("宋体", 21.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		this.label28.Location = new System.Drawing.Point(29, 71);
		this.label28.Name = "label28";
		this.label28.Size = new System.Drawing.Size(100, 29);
		this.label28.TabIndex = 62;
		this.label28.Text = "总烃：";
		this.label28.Visible = false;
		this.lbTHC.AutoSize = true;
		this.lbTHC.Cursor = System.Windows.Forms.Cursors.Hand;
		this.lbTHC.Font = new System.Drawing.Font("宋体", 21.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		this.lbTHC.Location = new System.Drawing.Point(159, 71);
		this.lbTHC.Name = "lbTHC";
		this.lbTHC.Size = new System.Drawing.Size(28, 29);
		this.lbTHC.TabIndex = 61;
		this.lbTHC.Text = "0";
		...
		this.tsmiSystem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[14]
		{
			...
			this.tsmiGraphGraft, this.tmiFactorSetting, this.登录账号ToolStripMenuItem
		});
		...
		this.选项ToolStripMenuItem.Size = new System.Drawing.Size(168, 38);
		...
		this.系统配置ToolStripMenuItem.Size = new System.Drawing.Size(168, 38);
		...
		this.ToolStripMenuItemClock.Size = new System.Drawing.Size(168, 38);
		...
		this.ToolStripMenuItemTempCtrl.Size = new System.Drawing.Size(168, 38);
		...
		this.气路配置ToolStripMenuItem.Size = new System.Drawing.Size(168, 38);
		...
		this.ToolStripMenuItemTime.Size = new System.Drawing.Size(168, 38);
		...
		this.tsmiGraphGraft.Size = new System.Drawing.Size(168, 38);
		...
		this.tmiFactorSetting.Size = new System.Drawing.Size(168, 38);
		...
		this.登录账号ToolStripMenuItem.Size = new System.Drawing.Size(168, 38);
		this.登录账号ToolStripMenuItem.Text = "登录账号";
		this.登录账号ToolStripMenuItem.Visible = false;
		this.登录账号ToolStripMenuItem.Click += new System.EventHandler(登录账号ToolStripMenuItem_Click);
		this.tsmiCheckMain.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[3] { this.ToolStripMenuItemGmp, this.权限管理ToolStripMenuItem, this.重新登录账号ToolStripMenuItem });
		...
		this.ToolStripMenuItemGmp.Size = new System.Drawing.Size(148, 22);
		...
		this.权限管理ToolStripMenuItem.Click += new System.EventHandler(权限管理ToolStripMenuItem_Click);
		this.重新登录账号ToolStripMenuItem.Name = "重新登录账号ToolStripMenuItem";
		this.重新登录账号ToolStripMenuItem.Size = new System.Drawing.Size(148, 22);
		this.重新登录账号ToolStripMenuItem.Text = "重新登录账号";
		this.重新登录账号ToolStripMenuItem.Click += new System.EventHandler(重新登录账号ToolStripMenuItem_Click);
		...
		this.tsslMemory.Size = new System.Drawing.Size(0, 17);
		this.tsslCpu.Name = "tsslCpu";
		this.tsslCpu.Size = new System.Drawing.Size(0, 17);
		...
		this.imageList2.Images.SetKeyName(0, "home_50px.png");
		this.imageList2.Images.SetKeyName(1, "test_tube_50px.png");
		this.imageList2.Images.SetKeyName(2, "template_50px.png");
		this.timerLow.Enabled = true;
		this.timerLow.Interval = 10000;
		this.timerLow.Tick += new System.EventHandler(timerLow_Tick);
		this.chromAcqCtrl1.Dock = System.Windows.Forms.DockStyle.Fill;
		this.chromAcqCtrl1.Location = new System.Drawing.Point(0, 22);
		...
		this.chromAcqCtrl1.Size = new System.Drawing.Size(865, 528);
		...
		this.chromDeviceCtrl1.Size = new System.Drawing.Size(300, 156);
		...
		this.insDeviceCtrl1.Size = new System.Drawing.Size(392, 714);
		this.insDeviceCtrl1.strIniTempHoldT = "0";
		...
		this.MainmstSet.Size = new System.Drawing.Size(392, 714);
		...
		this.spcLeftBottom.Panel1.ResumeLayout(false);
		this.spcLeftBottom.Panel2.ResumeLayout(false);
		this.spcLeftBottom.Panel2.PerformLayout();
