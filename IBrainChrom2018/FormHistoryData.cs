...
public class FormHistoryData : Form
{
	public static FormHistoryData selfCtrl;
	...
	private string[] strCmpdName = new string[11];
	...
	public void loadData()
	{
		...
		DataTable dataTableMINE = Class49.GetDataTableMINE(0, "HISDATA", dateTimePicker1.Value, dateTimePicker2.Value);
	...
	public void relodColumn()
	{
		...
		if (cdlMgr.ChartParaOperaList != null && cdlMgr.ChartParaOperaList[0].mtdMgr != null)
		{
			for (int i = 0; i < cdlMgr.ChartParaOperaList[0].mtdMgr.caliGnl.cmpds.Count(); i++)
			{
				DataGridViewColumn dataGridViewColumn = dataGridView1.Columns[i + 3];
				string name = (dataGridView1.Columns[i + 3].HeaderText = cdlMgr.ChartParaOperaList[0].mtdMgr.caliGnl.cmpds[i].cmpdInfo.name);
				dataGridViewColumn.Name = name;
				strCmpdName[i] = dataGridView1.Columns[i + 3].Name;
			}
			ch1.Text = strCmpdName[0];
			ch2.Text = strCmpdName[1];
			ch3.Text = strCmpdName[2];
			ch4.Text = strCmpdName[3];
			ch5.Text = strCmpdName[4];
			ch6.Text = strCmpdName[5];
			ch7.Text = strCmpdName[6];
			ch8.Text = strCmpdName[7];
			ch9.Text = strCmpdName[8];
			ch10.Text = strCmpdName[9];
			ch11.Text = strCmpdName[10];
			for (int j = cdlMgr.ChartParaOperaList[0].mtdMgr.caliGnl.cmpds.Count(); j < 20; j++)
			{
		...
		try
		{
			if (!frmParam.bSum[0])
			{
				dataGridView1.Columns.Remove(strCmpdName[0]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[1])
			{
				dataGridView1.Columns.Remove(strCmpdName[1]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[2])
			{
				dataGridView1.Columns.Remove(strCmpdName[2]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[3])
			{
				dataGridView1.Columns.Remove(strCmpdName[3]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[4])
			{
				dataGridView1.Columns.Remove(strCmpdName[4]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[5])
			{
				dataGridView1.Columns.Remove(strCmpdName[5]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[6])
			{
				dataGridView1.Columns.Remove(strCmpdName[6]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[7])
			{
				dataGridView1.Columns.Remove(strCmpdName[7]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[8])
			{
				dataGridView1.Columns.Remove(strCmpdName[8]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[9])
			{
				dataGridView1.Columns.Remove(strCmpdName[9]);
			}
		}
		catch
		{
		...
		try
		{
			if (!frmParam.bSum[10])
			{
				dataGridView1.Columns.Remove(strCmpdName[10]);
			}
		}
		catch
		{
	...
	private void InitChart()
	{
		...
		for (int i = 0; i < 11; i++)
		{
			...
			serieLines[i].LegendText = strCmpdName[i];
	...
	public void loadSeriesDate()
	{
		...
		{
			if (dataGridView1.Columns[strCmpdName[0]] != null && dataGridView1.Rows[k].Cells[strCmpdName[0]].Value != null)
			{
				serieLines[0].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[0]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[1]] != null && dataGridView1.Rows[k].Cells[strCmpdName[1]].Value != null)
			{
				serieLines[1].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[1]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[2]] != null && dataGridView1.Rows[k].Cells[strCmpdName[2]].Value != null)
			{
				serieLines[2].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[2]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[3]] != null && dataGridView1.Rows[k].Cells[strCmpdName[3]].Value != null)
			{
				serieLines[3].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[3]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[4]] != null && dataGridView1.Rows[k].Cells[strCmpdName[4]].Value != null)
			{
				serieLines[4].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[4]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[5]] != null && dataGridView1.Rows[k].Cells[strCmpdName[5]].Value != null)
			{
				serieLines[5].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[5]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[6]] != null && dataGridView1.Rows[k].Cells[strCmpdName[6]].Value != null)
			{
				serieLines[6].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[6]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[7]] != null && dataGridView1.Rows[k].Cells[strCmpdName[7]].Value != null)
			{
				serieLines[7].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[7]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[8]] != null && dataGridView1.Rows[k].Cells[strCmpdName[8]].Value != null)
			{
				serieLines[8].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[8]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[9]] != null && dataGridView1.Rows[k].Cells[strCmpdName[9]].Value != null)
			{
				serieLines[9].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[9]].Value.ToString());
			}
			if (dataGridView1.Columns[strCmpdName[10]] != null && dataGridView1.Rows[k].Cells[strCmpdName[10]].Value != null)
			{
				serieLines[10].Points.AddXY(strSerialTime[k], dataGridView1.Rows[k].Cells[strCmpdName[10]].Value.ToString());
			}
		}
		for (int l = 0; l < 11; l++)
		{
			serieLines[l].LegendText = strCmpdName[l];
	...
	private void btnExplorer_Click(object sender, EventArgs e)
	{
		...
		saveFileDialog.FileName = Application.StartupPath + "\\微量硫数据" + DateTime.Now.ToString("yyyyMMddHHmm") + ".xls";
	...
	public bool dataToExcel(DataGridView ordgv, string Outpath)
	{
		...
		try
		{
			...
			if (dataGridView != null && dataGridView.Rows.Count > 0)
			{
				...
				for (int j = 4; j < dataGridView1.SelectedRows.Count + 4; j++)
				{
					if (j > 4)
					{
					...
					for (int k = 0; k <= num2; k++)
					{
						...
						if (k == 1)
						{
							if (count + 3 - j > 0 && dataGridView1.SelectedRows[count + 2 - j].Cells[k].Value != null)
							{
								cell.SetCellValue(dataGridView1.SelectedRows[count + 2 - j].Cells[0].Value.ToString());
							}
						}
						else if (count + 3 - j > 0 && dataGridView1.SelectedRows[count + 2 - j].Cells[columnName].Value != null)
						{
							cell.SetCellValue(dataGridView1.SelectedRows[count + 2 - j].Cells[columnName].Value.ToString());
						}
					}
	...
	private void btnOpenChrom_Click(object sender, EventArgs e)
	{
		...
		DataTable dataTableRow = Class49.GetDataTableRow(0, "HISDATA", dateTimePicker1.Value, dateTime.ToString("yyyy-MM-dd HH:mm:ss"));
	...
	private void btnPrintf_Click(object sender, EventArgs e)
	{
		...
		richTextBox.Text += "..................................................................\r\n\r\n\r\n";
		string text = "";
		text = text + "打印时间:" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "\r\n\r\n\r\n";
		richTextBox.Text += text;
		text = "     分析结果（  ）  \r\n\r\n\r\n";
		richTextBox.Text += text;
		richTextBox.Text += "日期: ";
		string text2 = dataGridView1.SelectedRows[0].Cells["时间"].Value.ToString();
		richTextBox.Text += text2.Substring(0, 10);
		richTextBox.Text += "\r\n\r\n";
		...
		foreach (DataGridViewColumn column in dataGridView1.Columns)
		{
			if (column.Visible)
			{
				...
				if (array[num - 1] != "谱图" && array[num - 1] != "通道" && array[num - 1] != "方法名称")
				{
					richTextBox.Text += column.HeaderText;
					richTextBox.Text += "  ";
				}
			}
		}
		...
		for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
		{
			...
			{
				if (dataGridView1.SelectedRows[i].Cells[array[j]].Value != null && array[j] != "谱图" && array[j] != "通道" && array[j] != "方法名称")
				{
					text = ((!(array[j] == "时间")) ? (text + dataGridView1.SelectedRows[i].Cells[array[j]].Value.ToString()) : (text + dataGridView1.SelectedRows[i].Cells[array[j]].Value.ToString().Substring(10, 6)));
					text += "、";
				}
			}
			text += "\r\n";
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IBrainChrom2018.FormHistoryData));
		...
		this.splitContainer1.Panel2.Controls.Add(this.btnPrintf);
		...
		this.btnPrintf.Location = new System.Drawing.Point(7, 412);
		this.btnPrintf.Name = "btnPrintf";
		this.btnPrintf.Size = new System.Drawing.Size(192, 38);
		this.btnPrintf.TabIndex = 34;
		this.btnPrintf.Text = "数据打印";
		this.btnPrintf.UseVisualStyleBackColor = true;
		this.btnPrintf.Click += new System.EventHandler(btnPrintf_Click);
		this.btnExplorer2.Location = new System.Drawing.Point(7, 550);
