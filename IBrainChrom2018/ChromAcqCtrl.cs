...
public class ChromAcqCtrl : UserControl
{
	...
	public bool ShowLYTHCMethod
	{
		...
		set
		{
			...
			if (bLYTHCMethod)
			{
				...
				lclCPauseRefresh.Visible = false;
	...
	public void LoadLanguage()
	{
		...
		toolStripButton4.ToolTipText = Lang.PS("快照", "snap");
	...
	public void LoadChannelChartPara(ChannelChartPara oneEquipPara)
	{
		...
		Signal obj = currentTcpServerSocket.sglsSampling[currentChannelIdx];
		bool baseLinededuct = (checkBox8.Checked = oneEquipPara.bBaselineDeduction);
		obj.baseLinededuct = baseLinededuct;
	...
	private void timer_0_Tick(object sender, EventArgs e)
	{
		...
		{
			if (cdlMgr.CurrentChannelChartPara == null || !cdlMgr.CurrentChannelChartPara.bAutoFullY)
			{
				return;
			}
	...
	public void toolStripButton6_Click(object sender, EventArgs e)
	{
		...
		int currentChannelIdx = cdlMgr.CurrentChannelIdx;
		byte channelMask = (byte)currentChannelIdx;
		oneInstrum.SendCmd(245, channelMask);
	...
	private void toolStripButton4_Click(object sender, EventArgs e)
	{
		...
		{
			cdlMgr.CurrentTcpServerSocket.snapChromFile(cdlMgr.CurrentTcpServerSocket.mForm.CurrentChannelIndex);
		}
	}
	...
	private void tbTime_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
	{
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IBrainChrom2018.ChromAcqCtrl));
		...
		this.dpDatAcq.Location = new System.Drawing.Point(0, 76);
		this.dpDatAcq.Name = "dpDatAcq";
		this.dpDatAcq.Size = new System.Drawing.Size(1012, 493);
		...
		this.splitContainer3.Size = new System.Drawing.Size(1012, 76);
		...
		{
			this.tsStart, this.toolStripSeparator1, this.tsstop, this.toolStripButton6, this.toolStripSeparator2, this.toolStripButton4, this.toolStripButton5, this.toolStripButton7, this.toolStripSeparator3, this.toolStripButton1,
		...
		this.toolStripButton4.ToolTipText = "快照";
		...
		this.tbTime.MaskInputRejected += new System.Windows.Forms.MaskInputRejectedEventHandler(tbTime_MaskInputRejected);
		...
		base.Name = "ChromAcqCtrl";
		base.Size = new System.Drawing.Size(1012, 569);
