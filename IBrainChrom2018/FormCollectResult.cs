...
public class FormCollectResult : Form
{
	private ChromDeviceListMgr cdlMgr = ChromDeviceListMgr.Create();

	private LYTHCPara lythcParamMgr = LYTHCPara.Create();

	private float fsum = 0f;

	private float fMax = 0f;

	private float fMin = 0f;

	private float fsum2 = 0f;

	private float fMax2 = 0f;

	private float fMin2 = 0f;

	private float fsum3 = 0f;

	private float fMax3 = 0f;

	private float fMin3 = 0f;
	...
	public FormCollectResult()
	{
		...
		try
		{
			DataTable dataTable = Class49.GetDataTable("select * from LYTHCRLT");
			...
			{
				float num = Class49.String2Float(dataGridView1.Rows[i].Cells[0].Value, 0f);
				if (fMax < num)
				{
					fMax = num;
				}
				...
				fsum += num;
				num = Class49.String2Float(dataGridView1.Rows[i].Cells[1].Value, 0f);
				if (fMax2 < num)
				{
					fMax2 = num;
				}
				...
				fsum2 += num;
				num = Class49.String2Float(dataGridView1.Rows[i].Cells[2].Value, 0f);
				if (fMax3 < num)
				{
					fMax3 = num;
				}
			...
			{
				labThcAver.Text = (fsum / (float)(dataGridView1.Rows.Count - 1)).ToString("0.00");
				labThcMax.Text = fMax.ToString();
				labThcMin.Text = fMin.ToString();
				labCH4Avr.Text = (fsum2 / (float)(dataGridView1.Rows.Count - 1)).ToString("0.00");
				labCH4Max.Text = fMax2.ToString();
				labCH4Min.Text = fMin2.ToString();
				labNMHCAvr.Text = (fsum3 / (float)(dataGridView1.Rows.Count - 1)).ToString("0.00");
				labNMHCMax.Text = fMax3.ToString();
				labNMHCMin.Text = fMin3.ToString();
			}
			if (lythcParamMgr.detectorMode == 1)
			{
				DataTable dataTable2 = Class49.GetDataTable("select * from LYBTEXRLT");
		...
		if (lythcParamMgr.detectorMode == 0)
		{
			...
			groupBox3.Location = new Point(272, 180);
		}
	}
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IBrainChrom2018.FormCollectResult));
		...
		this.dataGridView1.Size = new System.Drawing.Size(245, 348);
		...
		this.btnPrintf.Location = new System.Drawing.Point(499, 315);
		...
		this.groupBox1.Location = new System.Drawing.Point(272, 141);
		...
		this.lbBTEX8T.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.lbBTEXt.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.lbBTEX7T.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.lbBTEX5T.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.lbBTEX6T.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.lbBTEX4T.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.lbBTEX2T.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.lbBTEX1T.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.lbBTEX3T.Font = new System.Drawing.Font("宋体", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
		...
		this.groupBox3.Location = new System.Drawing.Point(499, 141);
		...
		base.ClientSize = new System.Drawing.Size(686, 359);
