...
content = re.sub(r'func takeAuditSnapshot\(states \*sync\.Map\) \{[\s\S]*?log\.Println\("\[Audit\] Snapshot taken successfully at", snap\.Timestamp\)\s+\}', new_take, content)

with open(filepath, 'w', encoding='utf-8') as f:
    f.write(content)
print("audit_snapshot.go updated with advanced logs.")
