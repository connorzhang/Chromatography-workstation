...
{
	public static ReportPreviewForm form = null;

	public XtraReport m_curReport = null;
	...
	public DocumentViewer dvReport;

	public DocumentViewerBarManager dvbMgr;

	private Timer timer1;

	public ReportPreviewForm()
	{
		if (Lang.LangID == LangID.CN)
		{
	...
	public void ShowReportMain(XtraReport report)
	{
		m_curReport = report;
	...
	{
		dvReport.ExecCommand(PrintingSystemCommand.PrintDirect);
	}

	public void ShowReportMain(XtraReport[] reportList)
	{
		m_curReport = reportList[0];
		m_curReport.CreateDocument();
		int count = m_curReport.Pages.Count;
		for (int i = 1; i < reportList.Length; i++)
		{
			reportList[i].CreateDocument();
			for (int j = 0; j < reportList[i].Pages.Count; j++)
			{
				m_curReport.Pages.Insert(count++, reportList[i].Pages[j]);
			}
		}
		dvReport.DocumentSource = m_curReport;
		Show();
	}

	private void cbParerSize_SelectedIndexChanged(object sender, EventArgs e)
	{
		if (!m_bLoading)
		{
		}
	...
	private void ReportPreviewForm_FormClosing(object sender, FormClosingEventArgs e)
	{
		form = null;
	}
	...
	private void printPreviewBarItem23_ItemClick(object sender, ItemClickEventArgs e)
	{
		if (!m_bLoading)
		{
			timer1.Start();
	...
	private void timer1_Tick(object sender, EventArgs e)
	{
		...
		foreach (Form item in openForms)
		{
			...
			if (item.Text == "Watermark" || item.Text == "Page Setup" || text.Contains("PrintEditorForm"))
			{
				form = item;
				break;
			}
		...
		if (form != null)
		{
			CtrlLangPS.Instance.UpdateLanguageForAllControl(form);
			timer1.Stop();
		}
	}
	...
	private void printPreviewBarItem8_ItemClick(object sender, ItemClickEventArgs e)
	{
		if (!m_bLoading)
		{
			timer1.Stop();
	...
	private void printPreviewBarItem9_ItemClick(object sender, ItemClickEventArgs e)
	{
		if (!m_bLoading)
		{
			timer1.Stop();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(IBrainChrom2018.ReportMgr.ReportPreviewForm));
		this.splitter1 = new System.Windows.Forms.Splitter();
		this.dvReport = new DevExpress.XtraPrinting.Preview.DocumentViewer();
		this.dvbMgr = new DevExpress.XtraPrinting.Preview.DocumentViewerBarManager(this.components);
		...
		((System.ComponentModel.ISupportInitialize)this.dvbMgr).BeginInit();
		...
		this.dvReport.Location = new System.Drawing.Point(3, 55);
		this.dvReport.Name = "dvReport";
		this.dvReport.Size = new System.Drawing.Size(900, 420);
		this.dvReport.Status = "当前没有任何页面";
		this.dvReport.TabIndex = 3;
		this.dvbMgr.Bars.AddRange(new DevExpress.XtraBars.Bar[3] { this.previewBar1, this.previewBar2, this.previewBar3 });
		this.dvbMgr.DockControls.Add(this.barDockControlTop);
		this.dvbMgr.DockControls.Add(this.barDockControlBottom);
		this.dvbMgr.DockControls.Add(this.barDockControlLeft);
		this.dvbMgr.DockControls.Add(this.barDockControlRight);
		this.dvbMgr.DocumentViewer = this.dvReport;
		this.dvbMgr.Form = this;
		this.dvbMgr.ImageStream = (DevExpress.Utils.ImageCollectionStreamer)resources.GetObject("dvbMgr.ImageStream");
		this.dvbMgr.Items.AddRange(new DevExpress.XtraBars.BarItem[57]
		{
		...
		this.dvbMgr.MainMenu = this.previewBar3;
		this.dvbMgr.MaxItemId = 57;
		this.dvbMgr.PreviewBar = this.previewBar1;
		this.dvbMgr.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[3] { this.repositoryItemProgressBar1, this.repositoryItemZoomTrackBar1, this.printPreviewRepositoryItemComboBox1 });
		this.dvbMgr.StatusBar = this.previewBar2;
		this.dvbMgr.TransparentEditors = true;
		...
		this.previewBar1.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[25]
		{
		...
		this.printPreviewBarItem2.Caption = "文档布局";
		...
		this.printPreviewBarItem2.Hint = "文档布局";
		...
		this.printPreviewBarItem3.Caption = "参数";
		...
		this.printPreviewBarItem4.Hint = "查找";
		...
		this.printPreviewBarItem8.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(printPreviewBarItem8_ItemClick);
		...
		this.printPreviewBarItem9.Hint = "直接打印";
		this.printPreviewBarItem9.Id = 14;
		this.printPreviewBarItem9.ImageIndex = 1;
		this.printPreviewBarItem9.Name = "printPreviewBarItem9";
		this.printPreviewBarItem9.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(printPreviewBarItem9_ItemClick);
		...
		this.printPreviewBarItem11.Caption = "标题和页脚";
		...
		this.printPreviewBarItem11.Hint = "标题和页脚";
		...
		this.printPreviewBarItem13.Caption = "平移";
		...
		this.printPreviewBarItem13.Hint = "平移";
		...
		this.printPreviewBarItem14.Caption = "缩放工具";
		...
		this.printPreviewBarItem14.Hint = "缩放工具";
		...
		this.printPreviewRepositoryItemComboBox1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[1]
		{
		...
		this.printPreviewBarItem21.Caption = "多页面显示";
		...
		this.printPreviewBarItem21.Hint = "多页面显示";
		...
		this.printPreviewBarItem22.Caption = "&C背景颜色";
		...
		this.printPreviewBarItem23.Caption = "&W水印";
		...
		this.printPreviewBarItem26.Hint = "退出";
		...
		this.printPreviewStaticItem1.Caption = "无";
		...
		this.barDockControlBottom.Size = new System.Drawing.Size(903, 27);
		...
		base.ClientSize = new System.Drawing.Size(903, 502);
		base.Controls.Add(this.dvReport);
		base.Controls.Add(this.splitter1);
		base.Controls.Add(this.barDockControlLeft);
		base.Controls.Add(this.barDockControlRight);
		base.Controls.Add(this.barDockControlBottom);
		base.Controls.Add(this.barDockControlTop);
		base.Name = "ReportPreviewForm";
		base.Tag = "ReportManage";
		this.Text = "报表管理";
		base.WindowState = System.Windows.Forms.FormWindowState.Maximized;
		base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(ReportPreviewForm_FormClosing);
		base.FormClosed += new System.Windows.Forms.FormClosedEventHandler(ReportPreviewForm_FormClosed);
		base.Load += new System.EventHandler(ReportManage_Load);
		((System.ComponentModel.ISupportInitialize)this.dvbMgr).EndInit();
