...
# Remove the old round4 function (if any, wait, it's not there anymore in original file, I'll just remove if it exists)
content = re.sub(r'func round4\(v \*float64\) \*float64 \{.*?\}', '', content, flags=re.DOTALL)
